    ...
    public void onApplicationEvent(@NotNull ContextRefreshedEvent event) {
        ...
        tableActionMapper.createTable("""
                CREATE TABLE IF NOT EXISTS `column_info` (
                  ...
                  `user_database_name` varchar(100) DEFAULT NULL,
                  ...
                  PRIMARY KEY (`id`),
                  KEY `column_info_action_id_IDX` (`action_id`,`user_database_name`,`table_name`,`column_name`) USING BTREE
        ...
        databaseService.dropAllDatabase();
