export default function () {
    ...
    function toLabelValueMap(params) {
        let mapList = []
        for (const  value of params) {
            mapList.push({"label": value, "value": value})
        }
        return mapList
    }
    let charSetParams = toLabelValueMap([
        "armscii8",
        "ascii",
        "big5",
        "binary",
    ...
    const indexParams = toLabelValueMap([
        "KEY",
        "PRIMARY KEY",
        "UNIQUE KEY",
        "FULLTEXT KEY"
    ...
    const engineParams = toLabelValueMap([
        "MEMORY",
        "MRG_MYISAM",
        "CSV",
        "FEDERATED",
    ...
    let collationParams = toLabelValueMap([
        "armscii8_bin",
        "armscii8_general_ci",
        "ascii_bin",
        "ascii_general_ci",
